...
return [
    'plugin' => [
        'name' => 'Backend Plus',
        'description' => 'Nové užitočné funkcie a widgety pre back-end.',
        'author' => 'Gergő Szabó'
    ],
    'settings' => [
        'tab_display' => 'Zobrazenie',
        'avatar_label' => 'Kruhové profilové obrázky namiesto štvorcových',
        'avatar_comment' => 'Avatar sa zmení iba v hornom menu.',
